...
Agent action gate
For tool-using agents, separate:
answer
prepare
execute
Always ask for explicit confirmation before irreversible or external actions.
Purpose
This skill is not a jailbreak method and does not replace model-level safety systems. It is a lightweight behavior layer for safer AI-assistant and AI-agent use.
